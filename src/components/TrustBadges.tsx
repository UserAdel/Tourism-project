...
export default function TrustBadges() {
  ...
  return (
    <div className="bg-[#F9F5EE] dark:bg-[#071530] rounded-2xl p-6 shadow-lg border border-[var(--gold)]/10 dark:border-[var(--teal)]/10">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {badges.map((badge, index) => (
          <motion.div
            ...
            className="flex flex-col items-center text-center gap-2 p-3 rounded-lg hover:bg-[var(--sand)] dark:hover:bg-[#0B1E42] transition-colors"
          >
