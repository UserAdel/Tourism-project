...
export default function AdminLayout({ children, activeTab, counts }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[var(--dark-page)] lg:grid lg:grid-cols-[280px_minmax(0,1fr)]">
      <aside className="flex flex-col gap-5 border-b border-gray-200 bg-white px-4 py-5 shadow-sm dark:border-gray-700 dark:bg-[var(--dark-card)] lg:sticky lg:top-20 lg:h-[calc(100vh-5rem)] lg:border-b-0 lg:border-r">
        <div>
          <div className="mb-5">
        ...
        <button
          ...
          className="flex min-w-max items-center justify-center gap-2 rounded-lg border border-gray-200 px-4 py-3 text-sm font-semibold text-gray-600 transition-colors hover:border-red-200 hover:bg-red-50 hover:text-red-600 dark:border-gray-700 dark:text-gray-300 dark:hover:border-red-900/60 dark:hover:bg-red-950/20 lg:mt-auto lg:w-full lg:justify-start"
        >
