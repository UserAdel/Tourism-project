...
export default function PickupInfo({ zones, notes }: PickupInfoProps) {
  ...
  return (
    <div className="bg-white dark:bg-[var(--dark-card)] rounded-2xl p-8 shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        {zones.map((zone, index) => (
          <motion.div
            ...
            className="flex items-center gap-3 p-4 bg-[var(--sand)] dark:bg-[var(--dark-muted)] rounded-xl"
          >
      ...
      <div className="mt-6 bg-white dark:bg-[var(--dark-muted)] rounded-xl overflow-hidden h-64">
        <iframe
